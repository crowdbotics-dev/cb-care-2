"""
Django settings for cb_care_2 project.
...
WSGI_APPLICATION = 'cb_care_2.wsgi.application'
...
SPECTACULAR_SETTINGS = {
    ...
    "TITLE": "cb_care_2 API",
    "DESCRIPTION": "API documentation for cb_care_2 App",
    "VERSION": "v1",
}
